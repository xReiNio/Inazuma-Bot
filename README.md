...
### 方法一：直接執行 (推薦)
前往 [Releases 頁面](https://github.com/xReiNio/Inazuma-Bot/releases/tag/v0.1) 下載最新的 `.exe` 檔案，解壓縮後直接執行即可，無需安裝 Python。
...
1.  克隆此專案：
    ```bash
    git clone https://github.com/xReiNio/Inazuma-Bot.git
    ```
2.  安裝依賴套件：
    ```bash
